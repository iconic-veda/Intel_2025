...
if [ -z "$JRE" ] && [ -s "${CONFIG_HOME}/JetBrains/IdeaIC2024.2/idea.jdk" ]; then
  USER_JRE=$(cat "${CONFIG_HOME}/JetBrains/IdeaIC2024.2/idea.jdk")
...
elif [ -r "${CONFIG_HOME}/JetBrains/IdeaIC2024.2/idea64.vmoptions" ]; then
  USER_VM_OPTIONS_FILE="${CONFIG_HOME}/JetBrains/IdeaIC2024.2/idea64.vmoptions"
fi
